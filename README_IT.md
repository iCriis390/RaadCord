...
RaadCord è un fork di [Equicord](https://github.com/Equicord) & [Vencord](https://github.com/Vendicated/Vencord), con oltre 300+ plugin.
...
### Plugin Aggiunti su RaadCord
<details>
<summary>Clicca per vedere i plugin aggiunti a RaadCord</summary>

- **Surveillance** il nuovo miglior plugin di RaadCord che ti permette di poter fare Osint / fare SORVEGLIANZA DI MASSA su Persone e server discord. 
...
RaadCord ha le sue badge personali btw
...
> :exclamation: **IMPORTANTE** Assicurati di non usare un terminale amministratore/root da qui in poi. **Rovinerà** la tua installazione di Discord/RaadCord e molto probabilmente dovrai reinstallare.
...
Inietta RaadCord nel tuo client desktop:

```shell
pnpm inject
```

Compila RaadCord per il web:

```shell
pnpm buildWeb
```

Dopo aver compilato l'estensione web di RaadCord, individua il file ZIP appropriato nella directory `dist` e segui la guida del tuo browser per installare estensioni personalizzate, se supportato.
...
Vencord non è connesso a Equicord & RaadCord e come tali.

## Ringraziamenti speciali

Siamo orgogliosi di collaborare con [Nightcord](https://nightcord.st/).  
Le loro idee, le loro scelte di progettazione e parti del loro codice sono state integrate direttamente nella filosofia di sviluppo di RaadCord, influenzando diversi plugin e funzionalità.  
...
> [!WARNING]
> **RaadCord non è un client illegale.** La parola **"Illegal"** fa parte solo del nome del progetto e non significa che il software sia illegale di per sé.  
...
<details>
<summary>Usare RaadCord viola i termini di servizio di Discord</summary>
...
Inoltre, assicurati di non pubblicare screenshot con RaadCord in un server dove potresti essere bannato per questo.
