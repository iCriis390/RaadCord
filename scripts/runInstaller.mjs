...
const BASE_URL = "https://github.com/iCriis390/RaadCordInstaller/releases/latest/download/";
...
const LOCAL_INSTALLER_DIR = join(BASE_DIR, "RaadCordInstaller", "dist");
...
async function ensureBinary() {
    ...
    const res = await fetch(BASE_URL + filename, {
        headers: {
            "User-Agent": "RaadCord (https://github.com/iCriis390/RaadCord)",
            "If-None-Match": etag
        }
    });
