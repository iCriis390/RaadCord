...
import { EquicordDonorModal, EquicordTranslatorModal, RaadCordDonorModal, NightcordBadgeModal, TrashCordDonorModal, VencordDonorModal } from "./modals";

const CONTRIBUTOR_BADGE = "https://cdn.discordapp.com/emojis/1092089799109775453.png?size=64";
const EQUICORD_CONTRIBUTOR_BADGE = "https://equicord.org/assets/favicon.png";
const USERPLUGIN_CONTRIBUTOR_BADGE = "https://github.com/iCriis390/iCriis390/blob/main/Images/RaadCord.png?raw=true";
...
let RaadCordDonorBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const illegalcordBadges = await loadBadges("https://raw.githubusercontent.com/iCriis390/iCriis390/refs/heads/main/Images/badges.json", noCache);
    ...
    RaadCordDonorBadges = illegalcordBadges;
...
export default definePlugin({
    ...
    getRaadCordDonorBadges(userId: string) {
        return RaadCordDonorBadges[userId]?.map((badge, idx) => ({
            ...
            onClick(_event: React.MouseEvent, badge: ProfileBadge & BadgeUserArgs) {
                return RaadCordDonorModal(badge);
            },
        } satisfies ProfileBadge));
    },
