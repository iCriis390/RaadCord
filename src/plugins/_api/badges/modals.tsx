...
export function RaadCordDonorModal(badge: DonorBadgeModalProps) {
    openModal(props => (
        <ErrorBoundary noop onError={() => {
            props.onClose();
            VencordNative.native.openExternal("https://github.com/sponsors/iCriis390");
        }}>
            <Modal
                {...props}
                title={
            ...
            >
                <div>
                    ...
                    <div style={{ padding: "1em" }}>
                        ...
                        <Paragraph className={Margins.top20}>
                            Thank you for supporting RaadCord development! Your contribution helps keep this project alive and thriving.
                        </Paragraph>
                    </div>
                </div>
            </Modal>
