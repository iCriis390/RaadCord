        ...
        ContextMenuApi.openContextMenu(event, () => (
            ...
            >
                ...
                <Menu.MenuItem
                    ...
                    label="Open separate RaadCord window"
                    disabled={!!status || isBusy}
            ...
            <div className="vc-multi-instance-body">
                ...
                <div className="vc-multi-instance-modes">
                    ...
                    <div className="vc-multi-instance-mode-card">
                        <div className="vc-multi-instance-mode-icon"><MultiInstanceIcon /></div>
                        <div className="vc-multi-instance-mode-copy">
                            <strong>Separate RaadCord instance</strong>
                            <span>Gets its own taskbar identity and the RaadCord app icon.</span>
                        </div>
                    </div>
                </div>
...
export default definePlugin({
    name: "MultiInstance",
    description: "Opens extra RaadCord windows with separate Discord sessions.",
