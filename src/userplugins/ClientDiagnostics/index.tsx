        ...
        <div className={cl("page")}>
            <div className={cl("toolbar")}>
                <div>
                    ...
                    <BaseText size="sm" color="text-muted">
                        This page interprets the metrics and flags plugins that may make RaadCord lag.
                    </BaseText>
                </div>
    ...
    return (
        <div className={cl("page")}>
            ...
            <div className={cl("guide-section")}>
                ...
                <BaseText size="sm" color="text-muted">
                    The numbers are samples collected while you use RaadCord. If a plugin is not used during collection, it may look light even if it does more work in other situations.
                </BaseText>
            </div>
