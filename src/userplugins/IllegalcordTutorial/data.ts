...
export const TUTORIAL_SEEN_KEY = "RaadCordTutorial_seen_v1";
export const TUTORIAL_LANGUAGE_KEY = "RaadCordTutorial_language";
...
export const UI_COPY = {
    en: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "You can reopen this tutorial from the RaadCordTutorial settings.",
    ...
    it: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "Puoi riaprire questo tutorial dalle impostazioni di RaadCordTutorial.",
...
export const TUTORIAL_STEPS: TutorialStep[] = [
    {
        title: {
            en: "Welcome to RaadCord",
            it: "Benvenuta in RaadCord"
        },
        route: {
            en: "First startup",
            it: "Primo avvio"
    ...
    {
        title: {
            en: "RaadCord settings",
            it: "Impostazioni RaadCord"
        },
        route: {
            en: "Settings > RaadCord Settings",
            it: "Settings > RaadCord Settings"
        },
        body: {
            en: "The RaadCord section is the control room for the client. Start there when you want to change behavior or find a tool.",
            it: "La sezione RaadCord è la sala comandi del client. Parti da lì quando vuoi cambiare comportamento o trovare uno strumento."
        },
        bullets: {
            en: [
                "RaadCord contains general client settings.",
                "Plugins lists stock plugins, Equicord plugins, and userplugins.",
                "Themes, Updater, Changelog, and Backup each have their own page."
            ],
            it: [
                "RaadCord contiene le impostazioni generali del client.",
    ...
    },
    {
        ...
        route: {
            en: "Settings > RaadCord Settings > Plugins",
            it: "Settings > RaadCord Settings > Plugins"
        },
        body: {
    ...
    },
    {
        ...
        body: {
            en: "If RaadCord lags, freezes, or starts using too much memory, open Client Diagnostics before disabling random plugins.",
            it: "Se RaadCord lagga, si blocca, o usa troppa memoria, apri Client Diagnostics prima di disattivare plugin a caso."
        },
        bullets: {
            en: [
    ...
    },
    {
        ...
        route: {
            en: "Settings > RaadCord Settings > Themes",
            it: "Settings > RaadCord Settings > Themes"
        },
        body: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > RaadCord Settings > Updater",
            it: "Settings > RaadCord Settings > Updater"
        },
        body: {
            en: "Updater checks for RaadCord updates. Use it when a patch breaks, the client crashes, or you want the newest fixes.",
            it: "Updater controlla gli aggiornamenti di RaadCord. Usalo quando una patch si rompe, il client crasha, o vuoi gli ultimi fix."
        },
        bullets: {
            en: [
    ...
    },
    {
        ...
        route: {
            en: "Settings > RaadCord Settings > Changelog",
            it: "Settings > RaadCord Settings > Changelog"
        },
        body: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > RaadCord Settings > Backup & Restore",
            it: "Settings > RaadCord Settings > Backup & Restore"
        },
        body: {
