...
export default definePlugin({
    name: "RaadCordTutorial",
    description: "Shows a first-run guided tutorial for RaadCord features.",
    authors: [{ name: "irritably", id: 928787166916640838n }],
    required: true,
    enabledByDefault: true,
    settingsAboutComponent: SafeTutorialSettings,
    toolboxActions: {
        "Open RaadCord tutorial": openTutorial,
        "Show RaadCord tutorial next startup": resetTutorialSeen
    },
