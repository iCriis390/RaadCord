...
const PRIVATE_PARTITION_PREFIX = "RaadCord-private-search";
...
const PRELOAD_DIR = join(tmpdir(), "RaadCord-private-search-browser");
...
function getNavigationScript(homeUrl: string) {
    ...
    return `
        (() => {
            const id = "RaadCord-private-search-nav";
